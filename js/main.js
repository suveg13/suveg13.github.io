(function($) {
	...
	$('.cert-block, .menu-item').on('click', function() {

	    //Portfolio masonry
	    var $container = $('#cert-container');
	    $container.isotope({
	        masonry: {
	            columnWidth: '.cert-item'
	        },
	...
	//On Click Open Cert Block
	$('.cert-block, .menu-item.cert').on('click', function() {
		$('.content-blocks').removeClass('showx');
		$('.content-blocks.cert').addClass('showx');
		$('.menu-item').removeClass('active');
		$('.menu-item.cert').addClass('active');
	});
